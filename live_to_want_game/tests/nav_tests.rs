...
fn test_region_map_update() {
    println!("test_region_map_update test");
    let xlen:usize = 7;
    let ylen:usize = 5;
...
fn test_region_map_hypothetical_blocks() {
    ...
    assert_eq!(r.get_if_will_not_cause_blocked_paths(Vector2::new(5,3)), false);
    assert_eq!(r.get_if_will_not_cause_blocked_paths(Vector2::new(3,2)), true);
